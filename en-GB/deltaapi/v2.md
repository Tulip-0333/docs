...
`connected_users` | `integer` | How many *unique users* are connected to the server
`connected_clients` | `integer` | How many *clients* are connected to the server
...
**Only settings whose field is provided in the request will be altered.**
